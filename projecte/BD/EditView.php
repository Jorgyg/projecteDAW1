			...
			<div class="text-left">
				<form method="POST" action="./index.php">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="cognoms" name="cognoms" value="<?php echo $result[0]['Cognom']; ?>">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<select type="text" class="form-control" id="data_naixement" name="data_naixement" value="<?php echo $result[0]['Feina']; ?>">
